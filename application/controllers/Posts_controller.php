...
class Posts_controller extends Controller
{
	...
	public function view_posts()
	{
		...
		// create the content
		$view = new Html( 'application/views/posts' , 'posts.html' );
	...
	public function view_post($id)
	{
		...
		$comment = new Comment();
		$comments = $comment->find_all_by('post_id',$id);
		
		// create the view
		$view = new Html('application/views/posts','post.html');
		$view->set_var('id',$post->id);
	...
	public function add_post()
	{
		...
		// create the view
		$view = new Html('application/views/posts','add_post.html');
		$view->parse();
		$content = $view->get_body();
	...
	public function delete_post($id)
	{
		...
		// create the view
		$view = new Html('application/views/posts','manage_posts.html');
		$view->set_block( 'posts' , $posts );
		$view->parse();
		$content = $view->get_body();
	...
	public function edit_post($id,$title=null,$body=null)
	{
		...
		// create the view
		$view = new Html('application/views/posts','edit_post.html');
